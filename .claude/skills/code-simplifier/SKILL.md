...
Review and simplify TypeScript/React code in this repo (Next.js 16 App Router, TailwindCSS, shadcn/ui components) while respecting the project's constraints.
