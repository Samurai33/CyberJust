...
Patterns that apply to this repo's App Router + Radix/shadcn component architecture. Focused on this project's actual stack (Next.js 16, React 19, TailwindCSS, react-hook-form, zod), not generic textbook patterns.
