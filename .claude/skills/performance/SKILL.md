...
Systematic performance analysis for this Next.js 15 app, focusing on **Core Web Vitals** (LCP, INP, CLS), **JS bundle size**, and **hydration cost** — the README advertises "Loading times < 1s", treat that as the target.
